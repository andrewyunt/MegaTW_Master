 ...
 */
package com.andrewyunt.megatw.db;
...
import com.andrewyunt.megatw.utilities.BukkitSerialization;
...
public class MySQLSource extends DataSource {
    ...
    public void savePlayer(GamePlayer player) {
        ...
        String uuid = MegaTW.getInstance().getServer().getOfflinePlayer(player.getName()).getUniqueId().toString();
        
        if (MegaTW.getInstance().isEnabled()) {
    		BukkitScheduler scheduler = MegaTW.getInstance().getServer().getScheduler();
    		scheduler.runTaskAsynchronously(MegaTW.getInstance(), () -> {
    ...
    private void savePlayer(GamePlayer player, String uuid) {
    	...
    	com.andrewyunt.megatw.objects.Class classType = player.getClassType();
		...
		try {
			...
			MegaTW.getInstance().getLogger().severe(String.format(
			...
			try {
				while (resultSet.next()) {
					...
					if (!classStr.equals("none"))
						player.setClassType(com.andrewyunt.megatw.objects.Class.valueOf(classStr));
	...
	@Override
	public void saveLayout(GamePlayer player, com.andrewyunt.megatw.objects.Class classType, Inventory inv) {
		
		String uuid = MegaTW.getInstance().getServer().getOfflinePlayer(player.getName()).getUniqueId().toString();
		String version = MegaTW.getInstance().getDescription().getVersion();
	...
	@Override
	public Inventory loadLayout(GamePlayer player, com.andrewyunt.megatw.objects.Class classType) {
	...
	public Map<Integer, Map.Entry<OfflinePlayer, Integer>> getMostKills() {
		...
		try {
			...
			MegaTW.getInstance().getLogger().severe("An error occured while getting players with the most kills.");
		}
	...
	public void createPlayersTable() {
	    ...
	    try {
			...
			MegaTW.getInstance().getLogger().severe( "An error occured while creating the Players table.");
		}
	}
	...
	public void createLayoutsTable() {
	    ...
	    try {
			...
			MegaTW.getInstance().getLogger().severe( "An error occured while creating the Layouts table.");
		}
	}
	...
	public void createUpgradesTable() {
	    ...
	    try {
			...
			MegaTW.getInstance().getLogger().severe( "An error occured while creating the Upgrades table.");
		}
	}
	...
	public void cleanupLayouts() {
	    ...
	    try {
			...
			MegaTW.getInstance().getLogger().severe( "An error occured while cleaning the Layouts table.");
		}
	}
}
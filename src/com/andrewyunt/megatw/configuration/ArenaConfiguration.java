...
public class ArenaConfiguration {
	...
	public void reloadConfig() {
		...
		if (configFile == null)
			configFile = new File(MegaTW.getInstance().getDataFolder(), "arenas.yml");
		...
		try {
			defConfigStream = new InputStreamReader(MegaTW.getInstance().getResource("arenas.yml"), "UTF8");
	...
	public void saveDefaultConfig() {
	    ...
	    if (!configFile.exists())
	    	MegaTW.getInstance().saveResource("arenas.yml", false);
	}
}